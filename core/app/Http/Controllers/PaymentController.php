...
class PaymentController extends Controller
{
    ...
    public function depositConfirm()
    {
        ...
        if ($data->gateway_id == 101) {
            ...
            $paypal['track'] = $track;
            return view('dotcom.payment.paypal', compact('paypal', 'gnl'));
        } elseif ($data->gateway_id == 102) {
            $perfect['amount'] = $data->usd_amo;
            $perfect['value1'] = $gatewayData->val1;
            $perfect['value2'] = $gatewayData->val2;
            $perfect['track'] = $track;
            return view('dotcom.payment.perfect', compact('perfect', 'gnl'));
        } elseif ($data->gateway_id == 103) {
            $pt = $gatewayData->name;
            return view('dotcom.payment.stripe', compact('track', 'pt'));
        } elseif ($data->gateway_id == 104) {
            $page = $gatewayData->name;
            return view('dotcom.payment.skrill', compact('page', 'gnl', 'gatewayData', 'data'));
            ...
            return view('dotcom.payment.paytm', compact('page', 'post_params', 'form_action', 'gnl'));
            ...
            return view('dotcom.payment.payeer', compact('page', 'gnl', 'payeer_url', 'm_shop', 'm_orderid', 'm_amount', 'm_curr', 'm_desc', 'sign'));
            ...
            if ($data->btc_amo == 0 || $data->btc_wallet == "") {
                ...
                if (!$resp) {
                    return redirect()->route('user.dashboard')->with('alert', 'BLOCKCHAIN API HAVING ISSUE. PLEASE TRY LATER');
                }
            ...
            $bitcoin['code'] = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=$var&choe=UTF-";

            $pt = $gatewayData->name;
            return view('dotcom.payment.blockchain', compact('bitcoin', 'pt'));
            ...
            $qrurl = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=$varb&choe=UTF-8";
            return view('dotcom.payment.blockbtc', compact('bcoin', 'wallet', 'qrurl', 'pt'));
            ...
            $qrurl = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=$varb&choe=UTF-8";
            return view('dotcom.payment.blocklite', compact('bcoin', 'wallet', 'qrurl', 'pt'));
            ...
            $varb = $wallet;
            $qrurl = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=$varb&choe=UTF-8";
            return view('dotcom.payment.blockdog', compact('bcoin', 'wallet', 'qrurl', 'pt'));
            ...
            $qrurl = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=bitcoin:$wallet&choe=UTF-8";
            return view('dotcom.payment.coinpaybtc', compact('bcoin', 'wallet', 'qrurl', 'pt'));
            ...
            $qrurl = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=$wallet&choe=UTF-8";
            return view('dotcom.payment.coinpayeth', compact('bcoin', 'wallet', 'qrurl', 'pt'));
            ...
            $qrurl = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=$wallet&choe=UTF-8";
            return view('dotcom.payment.coinpaybch', compact('bcoin', 'wallet', 'qrurl', 'pt'));
            ...
            $qrurl = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=$wallet&choe=UTF-8";
            return view('dotcom.payment.coinpaydash', compact('bcoin', 'wallet', 'qrurl', 'pt'));
            ...
            $qrurl = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=$wallet&choe=UTF-8";
            return view('dotcom.payment.coinpaydoge', compact('bcoin', 'wallet', 'qrurl', 'pt'));
            ...
            $qrurl = "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=$wallet&choe=UTF-8";
            return view('dotcom.payment.coinpayltc', compact('bcoin', 'wallet', 'qrurl', 'pt'));
            ...
            if ($order) {
                ...
                return redirect()->route('user.dashboard')->with('alert', 'Unexpected Error! Please Try Again');
                exit();
            }
            ...
            $pt = $method->name;
            return view('dotcom.payment.coinpay', compact('bcoin', 'form', 'pt', 'amon'));
        }
