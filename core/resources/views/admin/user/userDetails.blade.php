        ...
        <div class="row">
            ...
            <div class="col-md-9">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="widget-small warning coloured-icon"><i class="icon fa fa-reply"
                ...
                <div class="tile">
                    <div class="card">
                            ...
                            <div class="row align-items-center">
                                <div class="col d-flex">
                                    <a class="btn btn-primary"
                                       href="{{route('admin.manage_balance',[ $data->id])}}">Manage Current Balance</a>
                                    <a class="btn btn-primary ml-2"
                                       href="{{route('admin.debit_account',[ $data->id])}}">Debit Account
                                    </a>
                                    <a class="btn btn-primary ml-2"
                                       href="{{route('admin.credit_account',[ $data->id])}}">Credit Account
                                    </a>
                                    <a class="btn btn-primary ml-2"
                                       href="{{route('admin.users.transaction-history.index',[$data->id])}}">Transaction
                                        History
                                    </a>
                                </div>
                            </div>
                        ...
                        {{--                                       href="{{route('admin.withdraw.report', $data->id)}}">Withdraw Report</a>--}}
                        {{--                                    <br>--}}
                        {{--                                </div>--}}

                        {{--                                <div class="col-md-6">--}}
                        {{--                                    <a class="btn btn-primary btn-block"--}}
                        {{--                                       href="{{route('admin.transaction.report', $data->id)}}">Transaction Report--}}
                        {{--                                        <br></a>--}}
                        {{--                                </div>--}}
                        {{--                            </div>--}}
                        {{--                            <br>--}}
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="checkbox" name="user_banned"
                                       ...
                                       data-toggle="toggle" data-on="Active" data-off="Blocked" data-onstyle="success"
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="checkbox" name="email_verified"
                                       ...
                                       data-toggle="toggle" data-on="Verified" data-off="Unverified"
                                       data-onstyle="success" data-offstyle="danger" data-width="100%">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="exampleInputEmail1">@lang('Mobile Verification')</label><br>
                                <input type="checkbox" name="sms_verified" @if($data->sms_verified == 1) checked
                                       @endif data-toggle="toggle" data-on="Verified" data-off="Unverified"
                                       data-onstyle="success" data-offstyle="danger" data-width="100%">
                            </div>
                        </div>
