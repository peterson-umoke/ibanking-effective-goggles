        ...
        <div class="container">
            ...
            <div class="row calculate justify-content-center">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="sbox">
                        <div class="image">
                            <form method="post" action="{{route('user.profile.image.upload')}}"
                                ...
                                <div class="form-group col-md-12">
                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail"
                                             style="max-width: 252px; max-height: 252px;">
                                            @if(Auth::user()->avatar != NULL)
                                                <img src="{{asset('assets/image/avatar/'.Auth::user()->avatar)}}"
                                                     alt="">
                                        ...
                                        <div class="fileinput-preview fileinput-exists thumbnail"
                                             style="max-width: 512px; max-height: 512px;"></div>
                                        <div>
                ...
                <div class="col-md-12 col-lg-9">
                    <div class="box">
                        ...
                        <form action="{{route('user.profile.update')}}" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    <fieldset>
                                        ...
                                        <input class="form-control" value="{{ Auth::user()->account_number}}"
                                               placeholder="Readonly input here…" readonly="">
                                    </fieldset>
                                </div>
                            ...
                            <div class="tile-footer">
                                <button class="btn mr_btn_solid" style="  width: 100%!important; margin-bottom: 20px;"
                                        type="submit">@lang('Update')</button>
                            </div>
                        </form>
                    </div>
