...
Route::view('about-us', 'dotcom.about')->name('about');
Route::view('our-services', 'dotcom.services')->name('services');
Route::view('investor-relations', 'dotcom.investor-relations')->name('investor-relations');
Route::view('sustainability', 'dotcom.sustainability')->name('sustainability');
...
Route::group(['prefix' => 'admin', 'middleware' => 'auth:admin', 'as' => 'admin.'], function () {
    ...
    Route::resource('users.transaction-history', 'UserTransactionHistoryController')->except(['edit', 'update']);
    Route::prefix('users')->group(function () {
        Route::get('manage_balance/{id}', 'UserController@manage_balance')->name('manage_balance');
        Route::get('debit_account/{id}', 'UserController@debit_account')->name('debit_account');
        Route::get('credit_account/{id}', 'UserController@credit_account')->name('credit_account');
        Route::patch('update_balance/{id}', 'UserController@update_balance')->name('update_balance');
    });
...
Route::group(['prefix' => 'user', 'middleware' => 'auth', 'as' => 'user.'], function () {
    ...
    Route::group(['middleware' => 'active_status'], function () {
        ...
        Route::group(['middleware' => 'verify_user'], function () {
            ...
            Route::post('/transfer/balance/other-bank', 'UserController@storeTransferLog')->name('transfer.otherBank');
//            Route::post('/transfer/balance/other-bank', 'UserController@transferOtherBank')->name('transfer.otherBank');
            ...
            Route::get("transfer/balance/other-bank/confirm-pincode", 'UserController@getOtp')->name("otherbank.getOtp");
            Route::post("transfer/balance/other-bank/confirm-pincode", 'UserController@saveTransferLog')->name("otherbank.storeDataTrans");
        });
